...
*/ //var macchina_completa=new THREE.Object3D();
  ...
  var corpoGeometry = new THREE.BoxGeometry(3, 1, 2);
  var corpoMaterial = new THREE.MeshBasicMaterial({
    color: colore,
    side: THREE.DoubleSide
  });
  var corpo = new THREE.Mesh(corpoGeometry, corpoMaterial);
  corpo.position.set(-4, 0, 0);

  var corpo2Geometry = new THREE.BoxGeometry(2, 1, 3);
  var corpo2Material = new THREE.MeshBasicMaterial({
    color: colore,
    side: THREE.DoubleSide
  });
  var corpo2 = new THREE.Mesh(corpo2Geometry, corpo2Material);
  corpo2.position.set(-1, 0, 0);


  var musoGeometry = new THREE.BoxGeometry(3, 1, 1);
  var musoMaterial = new THREE.MeshBasicMaterial({
    color: colore,
    side: THREE.DoubleSide
  });
  ...
  var alaAnterioreMaterial = new THREE.MeshBasicMaterial({
    color: colore,
    side: THREE.DoubleSide
  });
  ...
  var retroMaterial = new THREE.MeshBasicMaterial({
    color: colore,
    side: THREE.DoubleSide
  });
  var retro = new THREE.Mesh(retroGeometry, retroMaterial);
  retro.position.set(-3, 0, 0);

  var tettoGeometry = new THREE.BoxGeometry(2.5, 1, 1)
  var tettoMaterial = new THREE.MeshBasicMaterial({
    color: colore,
    side: THREE.DoubleSide
  });
  var tetto = new THREE.Mesh(tettoGeometry, tettoMaterial);
  tetto.position.set(-1, 1, 0);

  var alettone = new THREE.Mesh(alaAnterioreGeometry, alaAnterioreMaterial); //alettone=ala anteriore
  alettone.position.set(-4, 1, 0);

  var ruotaGeometry = new THREE.BoxGeometry(1, 1, 1);
  var ruotaMaterial = new THREE.MeshBasicMaterial({
    color: 0x000000,
    side: THREE.DoubleSide
  });
  ruota = [];
  ...
  ruota[2].position.set(-3, 0, 1);
  ruota[3].position.set(-3, 0, -1);
